...
/**
 * 文件名：com.dongxaing.demospringboot03configlogger.properties.PropertiesMy2
 * <br>   作者：Dongxiang
 ...
 */
@Component
@PropertySource(value = {"classpath:my2.properties"})
@ConfigurationProperties(prefix = "my2")
public class PropertiesMy2 {
    ...
    public PropertiesMy2() {
    }

    @Override
    public String toString() {
        return "PropertiesMy2{" +
                "age=" + age +
                ", name='" + name + '\'' +
                ", email='" + email + '\'' +
                '}';
